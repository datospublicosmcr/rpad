...
// =====================================================
// ICON SELECTOR (para proyectos)
// =====================================================

const ICON_SELECTOR_MAP = {
...
function getIconSvg(iconName, size) {
    if (!iconName) return Icons.clipboardList;
    const key = ICON_SELECTOR_MAP[iconName];
    let svg = key ? Icons[key] : Icons.clipboardList;
    if (size && svg) {
